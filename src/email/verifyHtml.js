export const htmlCode = (id) => {
  return `
    ...
    <title>New email template 2023-07-18</title><!--[if (mso 16)]>
    <style type="text/css">
    ...
    <tr>
    <td align="center" style="padding:0;Margin:0;position:relative"><img class="adapt-img" src="https://xpbftu.stripocdn.email/content/guids/bannerImgGuid/images/image16896939830499131.png" alt="" title="" width="510" style="display:block;font-size:18px;border:0;outline:none;text-decoration:none" height="324"></td>
    </tr>
    </table></td>
    </tr>
    </table></td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
    <tr>
    <td align="center" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;line-height:21px;letter-spacing:0;color:#5D541D;font-size:14px">Thanks,<br>smart code team</p></td>
    </tr>
    </table></td>
    </tr>
    </table></td>
